...
public class SplashFragment extends Fragment implements View.OnClickListener{
    ...
    public static SplashFragment getInstance(int index){
    ...
    static class MyHandler extends Handler {
        ...
        SplashFragment splaceFragment;
        public MyHandler(SplashFragment fragment){
            weakReference = new WeakReference<SplashFragment>(fragment);
